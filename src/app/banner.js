  ...
  return (
    <div>
      {consentGiven === 'undecided' && (
        <div className="sticky top-0 z-4 flex gap-4 items-center flex-col sm:flex-row rid-rows-[20px_1fr_20px] justify-items-center  p-8  bg-green-300  dark:bg-green-600 ">
